...
function NotificationPage() {
  return (
    <Box display="flex" flexDirection="column" justifyContent="flex-start" alignItems="center" height="100vh" padding="20px" sx={{ backgroundColor: '#ffebee' }}>
      <Card sx={{ width: '100%', maxWidth: '400px', textAlign: 'center', boxShadow: 5, borderRadius: 3 }}>
        <CardContent>
          <Typography variant="h5" color="#070F2B" fontWeight="bold" gutterBottom>
            오늘의 알레르기 위험도
          </Typography>
          ...
          {/* 행동 지침 */}
          <Typography variant="h6" color="#070F2B" gutterBottom>
            행동 지침
          </Typography>
